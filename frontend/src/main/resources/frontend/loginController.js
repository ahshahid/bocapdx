...
var myApp = angular.module('loginApp', ['ngStorage']);
...
function unmarkForBasicQuery() {
  ...
  function getUser() { return $localStorage.username }
  function getPassword() { return $localStorage.password }
